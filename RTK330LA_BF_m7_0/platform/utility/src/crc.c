 ...
 * @param crc ==
********************************************/
static void crc_check( uint8_t const poly [],
 ...
 *  
 ******************************************************************************/
static void CrcCcittTypeToBytes (CrcCcittType const type, uint8_t bytes [])
{
	bytes[0] = (uint8_t)((type >> ONE_BYTE) & (uint8_t)BYTE_0);
 ...
 * @return
 ******************************************************************************/
static CrcCcittType BytesToCrcCcittType (uint8_t const bytes [])
{
	uint16_t tmp;
 ...
 *  
 ******************************************************************************/
static void Crc32TypeToBytes(Crc32Type const type, uint8_t bytes [])
{
 ...
 * @return
 ******************************************************************************/
static Crc32Type BytesToCrc32Type (uint8_t const bytes [])
{
 ...
 * @return crc
 ******************************************************************************/
static CrcCcittType CrcCcitt(uint8_t const data[], uint16_t const length,
    CrcCcittType const seed)
{
    ...
    crc_check(CRC_CCITT_POLY, CRC_CCITT_LENGTH,
      crc, data, length, crc);
