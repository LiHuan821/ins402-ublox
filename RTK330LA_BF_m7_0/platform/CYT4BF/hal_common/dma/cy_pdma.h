...
* \{
*/
#define CY_PDMA_INTRCAUSE_NO_INTR                (0x00u) /**< No interrupt                         */
#define CY_PDMA_INTRCAUSE_COMPLETION             (0x01u) /**< Completion                           */
#define CY_PDMA_INTRCAUSE_SRC_BUS_ERROR          (0x02u) /**< Source bus error                     */
#define CY_PDMA_INTRCAUSE_DST_BUS_ERROR          (0x04u) /**< Destination bus error                */
#define CY_PDMA_INTRCAUSE_SRC_MISAL              (0x08u) /**< Source address is not aligned        */
#define CY_PDMA_INTRCAUSE_DST_MISAL              (0x10u) /**< Destination address is not aligned   */
#define CY_PDMA_INTRCAUSE_CURR_PTR_NULL          (0x20u) /**< Current descripror pointer is NULL   */
#define CY_PDMA_INTRCAUSE_ACTIVE_CH_DISABLED     (0x40u) /**< Active channel is disabled           */
#define CY_PDMA_INTRCAUSE_DESCR_BUS_ERROR        (0x80u) /**< Descriptor bus error                 */
...
*
*******************************************************************************/
__STATIC_INLINE void Cy_PDMA_Chnl_SetSwTrigger(volatile stc_DMAC_t *pstcPDMA, uint32_t chNum)
{
    pstcPDMA->CH[chNum].unTR_CMD.stcField.u1ACTIVATE = 1ul;
}
