...
typedef struct {
    double      hotTempValue;   /**< Pass the hot temperature reading */
    double      roomTempValue;  /**< Pass the room temperature reading */
    double      coldTempValue;  /**< Pass the cold temperature reading */
    double      hotAdcValue;    /**< Pass the adc reading at hot temperature*/
    double      roomAdcValue;   /**< Pass the adc reading at room temperature*/
    double      coldAdcValue;   /**< Pass the adc reading at cold temperature*/
} cy_en_adc_temp_sflash_data_t;

/** ADC ref data values structure read form SFLASH */
typedef struct {
    double                       adcVbgValue;        /**< Pass the Vbg read value from SFLASH */
    cy_en_adc_temp_sflash_data_t adcTempSortValues;  /**< Pass the sort data values from SFLASH */
    cy_en_adc_temp_sflash_data_t adcTempClassValues; /**< Pass the class data values from SFLASH */
