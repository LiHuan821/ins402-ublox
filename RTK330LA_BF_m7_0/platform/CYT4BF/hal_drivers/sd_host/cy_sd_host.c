...
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_eMMC_InitCard(stc_SDHC_t *base,
...
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_OpsSetBlockCount(stc_SDHC_t *base, 
                                                                   bool reliableWrite,
                                                                   uint32_t blockNum);
...
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_MmcOpsSendOpCond(stc_SDHC_t *base,
                                                        ...
                                                        uint32_t cmdArgument,
                                                        cy_stc_sd_host_context_t *context);
static cy_en_sd_host_status_t Cy_SD_Host_SdCardChangeClock(stc_SDHC_t *base, uint32_t frequency);
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_PollBufferReadReady(stc_SDHC_t *base);
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_PollBufferWriteReady(stc_SDHC_t *base);
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_PollCmdComplete(stc_SDHC_t *base);
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_PollTransferComplete(stc_SDHC_t *base);
...
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_PollCmdLineFree(stc_SDHC_t const *base);
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_PollDataLineNotInhibit(stc_SDHC_t const *base);
__STATIC_INLINE cy_en_sd_host_status_t Cy_SD_Host_PollDataLineFree(stc_SDHC_t const *base);                                                 
...
*
*******************************************************************************/
static cy_en_sd_host_status_t Cy_SD_Host_CmdRxData(stc_SDHC_t *base, 
