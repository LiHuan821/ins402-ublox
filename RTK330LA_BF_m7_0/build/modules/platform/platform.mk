...
include ${PLATFORM_MAKEFILES_ROOTDIR}/gpio/gpio.mk
...
PLATFORM_CINCDIRS_SPLIT+=   \
							...
							${DRIVER_CINCDIRS} ${GPIO_CINCDIRS} 		\
							${STA9100_CINCDIRS} ${UTILITY_CINCDIRS}
...
PLATFORM_C_SOURCES_SPLIT+=  \
							...
							${DRIVER_C_SOURCES} ${GPIO_C_SOURCES}			\
							${STA9100_C_SOURCES} ${UTILITY_C_SOURCES}
PLATFORM_C_SOURCES:= $(foreach c_file,$(strip ${PLATFORM_C_SOURCES_SPLIT} ), ./platform/${c_file})


PLATFORM_CDEFS:=   			\
							${CYPRESS_SDK_CDEFS} ${CYT4BF_CDEFS} 	\
							${DRIVER_CDEFS} ${GPIO_CDEFS}			\
							${STA9100_CDEFS} ${UTILITY_CDEFS}
