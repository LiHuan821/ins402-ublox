...
DEFINE_TYPES(         U8, uint8_t)
DEFINE_TYPES(         S8, int8_t)
DEFINE_TYPES(        U16, uint16_t)
DEFINE_TYPES(        S16, int16_t)
DEFINE_TYPES(        U32, uint32_t)
DEFINE_TYPES(        S32, int32_t)
...
#elif defined (OS_WIN) || defined (OS_NUCLEUS) || defined (WIN32) || defined (_WIN64)
