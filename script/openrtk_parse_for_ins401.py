...
class InceptioParse:
    ...
    def log(self, output, data):
        ...
        if output['name'] == 's1':
            ...
            buffer = buffer + format(data[1], output['payload'][1]['format']) + ","
            buffer = buffer + format(data[2], output['payload'][2]['format']) + ","
            buffer = buffer + format(data[3]*180/2147483648, output['payload'][3]['format']) + ","
            buffer = buffer + format(data[4]*180/2147483648, output['payload'][4]['format']) + ","
            buffer = buffer + format(data[5], output['payload'][5]['format']) + ","
            buffer = buffer + format(data[6], output['payload'][6]['format']) + ","
            buffer = buffer + format(data[7], output['payload'][7]['format']) + ","
            ...
            buffer = buffer + format(data[0], output['payload'][0]['format']) + ","
            data_test = int(data[1] * 100) / 100
            #print(data_test)
            buffer = buffer + format(data_test, output['payload'][1]['format']) + ","
            buffer = buffer + format(data[2], output['payload'][2]['format']) + ","
            buffer = buffer + format(data[3], output['payload'][3]['format']) + ","
            buffer = buffer + format(data[4]*180/2147483648, output['payload'][4]['format']) + ","
            buffer = buffer + format(data[5]*180/2147483648, output['payload'][5]['format']) + ","
            buffer = buffer + format(data[6], output['payload'][6]['format']) + ","
            buffer = buffer + format(data[7]/100, output['payload'][7]['format']) + ","
            buffer = buffer + format(data[8]/100, output['payload'][8]['format']) + ","
            buffer = buffer + format(data[9]/100, output['payload'][9]['format']) + ","
            buffer = buffer + format(data[10]/100, output['payload'][10]['format']) + ","
            buffer = buffer + format(data[11]/100, output['payload'][11]['format']) + ","
            buffer = buffer + format(data[12]/100, output['payload'][12]['format']) + "\n"

            if math.fmod(data_test+0.0005, 0.1) <= 0.005:
                ff_buffer = '$GPINS,'
                ff_buffer = ff_buffer + format(data[0], output['payload'][0]['format']) + ","
                ff_buffer = ff_buffer + format(data_test, output['payload'][1]['format']) + ","
                ff_buffer = ff_buffer + format(data[4]*180/2147483648, output['payload'][4]['format']) + ","
                ff_buffer = ff_buffer + format(data[5]*180/2147483648, output['payload'][5]['format']) + ","
                ff_buffer = ff_buffer + format(data[6], output['payload'][6]['format']) + ","
                ff_buffer = ff_buffer + format(data[7]/100, output['payload'][7]['format']) + ","
                ff_buffer = ff_buffer + format(data[8]/100, output['payload'][8]['format']) + ","
                ff_buffer = ff_buffer + format(data[9]/100, output['payload'][9]['format']) + ","
                ff_buffer = ff_buffer + format(data[10]/100, output['payload'][10]['format']) + ","
                ...
                e_buffer = ''
                e_buffer = e_buffer + format(data[0], output['payload'][0]['format']) + ","
                e_buffer = e_buffer + format(data_test, output['payload'][1]['format']) + ","
                e_buffer = e_buffer + format(data[4]*180/2147483648, output['payload'][4]['format']) + ","
                ...
                if abs(data[5]*data[4]) > 0.00000001:
                    #print(data[1],data_test)
                    data_to_append = list(data)
                    data_to_append[1] = data_test
                    self.insdata.append(tuple(data_to_append))

        elif output['name'] == 'd1':
            buffer = buffer + format(data[0], output['payload'][0]['format']) + ","
            buffer = buffer + format(data[1], output['payload'][1]['format']) + ","
            buffer = buffer + format(data[2]/100, output['payload'][2]['format']) + ","
            buffer = buffer + format(data[3]/100, output['payload'][3]['format']) + ","
            buffer = buffer + format(data[4]/100, output['payload'][4]['format']) + ","
            buffer = buffer + format(data[5]/100, output['payload'][5]['format']) + ","
            buffer = buffer + format(data[6]/100, output['payload'][6]['format']) + ","
            buffer = buffer + format(data[7]/100, output['payload'][7]['format']) + ","
            buffer = buffer + format(data[8]/100, output['payload'][8]['format']) + ","
            buffer = buffer + format(data[9]/100, output['payload'][9]['format']) + ","
            buffer = buffer + format(data[10]/100, output['payload'][10]['format']) + "\n"
