...
*/
    ...
    #define CY_SYSTEM_PLL1_CONFIG_REFDIV      (3UL)
    ...
    #define CY_SYSTEM_PLL2_CONFIG_REFDIV      (3UL)
    #define CY_SYSTEM_PLL2_CONFIG_FEEDBACKDIV (30UL)
    ...
    #define CY_SYSTEM_PLL3_CONFIG_REFDIV      (3UL)
...
void SystemInit (void)
{
    ...
    Cy_Power_SwitchToTransistor(CY_SYSREGHC_VADJ_1V070, false);
#endif
    ...
    SRSS->unCLK_ECO_CONFIG2.stcField.u4ATRIM  = 0u;
    SRSS->unCLK_ECO_CONFIG2.stcField.u2FTRIM  = 3u;
    SRSS->unCLK_ECO_CONFIG2.stcField.u2RTRIM  = 1u;
    //SRSS->unCLK_ECO_CONFIG2.stcField.u3GTRIM  = 4u; 5  7
    SRSS->unCLK_ECO_CONFIG2.stcField.u3GTRIM  = 7u;
#endif
    ...
    struct {cy_en_hf_clk_dividers_t targetDiv; cy_en_hf_clk_sources_t source;} clkHfSetting[SRSS_NUM_HFROOT] = 
    {
        ...
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH1 /* PLL0: PLL400#0 */ }, // setting for clk_hf3
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_4, .source = CY_SYSCLK_HFCLK_IN_CLKPATH3 /* PLL2: PLL200#0 */ }, // setting for clk_hf4
    ...
    for(int8_t i_clkHfNo = 0ul; i_clkHfNo < SRSS_NUM_HFROOT; i_clkHfNo++)
    {
        ...
        {
            /***   Enabling MONZA PMIC     ***/
            //Cy_Power_SwitchToPmic(CY_SYSREGHC_VADJ_1V100, CY_POWER_PMIC_ENABLE_HIGH, CY_POWER_PMIC_STATUS_ABNORMAL_LOW, 0u, false);
            Cy_Power_SwitchToPmic(CY_SYSREGHC_VADJ_1V100, CY_POWER_PMIC_ENABLE_HIGH, CY_POWER_PMIC_STATUS_ABNORMAL_LOW, 0u, true);
        }
