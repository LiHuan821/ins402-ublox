...
* Device Adapter
***************************************/
#define CY_FLASH_IS_MCU_BODY_ENTRY (defined (tviibe512k) || defined (tviibe1m) || defined (tviibe2m) || defined (tviibe4m))
...
__STATIC_INLINE void Cy_Flashc_InvalidateFlashCacheBuffer(void)
{
    ...
    (void)FLASHC->unFLASH_CMD.u32Register;
}
