...
} cy_stc_ipc_pipe_internal_cfrun_status_t;


/** Create an array of endpoint structures */
static cy_stc_ipc_pipe_internal_cfrun_status_t  cy_ipc_pipe_epCfgStatus[CY_IPC_PIPE_MAX_ENDPOINTS];
...
static void ExecCallback(cy_stc_ipc_pipe_internal_cfrun_status_t * endpoint);
...
static void InitEndpoint(uint32_t epAddr, cy_stc_ipc_pipe_ep_config_t const * epConfig, uint32_t intMask, cy_en_intr_t epSysInt)
{
    cy_stc_ipc_pipe_internal_cfrun_status_t * endpoint;
...
cy_en_ipc_pipe_status_t Cy_IPC_Pipe_SendMessage(uint32_t toEpIndex, void * msgPtr, cy_ipc_pipe_relcallback_ptr_t callBackPtr)
{
    ...
    cy_stc_ipc_pipe_internal_cfrun_status_t * fromEp;
    cy_stc_ipc_pipe_internal_cfrun_status_t * toEp;
