...
static un_srom_api_scrach_sram_t g_scratch; // This must locate on SRAM.
static un_srom_api_args_2_t      g_scratch2; // This must locate on SRAM.
...
* API finished. This function does not set NVIM. NVIC settings including enabling
