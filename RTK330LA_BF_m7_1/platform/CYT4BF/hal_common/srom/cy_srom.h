...
typedef enum
{
    ...
    CY_SROM_STATUS_INVALID_TOC1                        = (int32_t)(0xF0000018ul), // Table of contents 1Åfs CRC check failed or /and magic number is not present
    ...
    CY_SROM_STATUS_INVALID_TOC2                        = (int32_t)(0xF0000020ul), // Table of contents2Åfs CRC check failed or /and magic number is not present
    ...
    CY_SROM_STATUS_ERROR_CORRECTION_FAILED             = (int32_t)(0xF0000086ul), // FLASH APIÅfs were not able to retrieve majority data when fetching HV parameters
    ...
    CY_SROM_STATUS_INVALID_FACTORY_HASH                = (int32_t)(0xF00000B5ul), // Returned when FACTORY_HASH1(in NORMAL1) or FACTORY_HASH2(in NORMAL2) doesnÅft match
    ...
    CY_SROM_STATUS_PU_REJECTED                         = (int32_t)(0xF00000C6ul), // Returned by Read & WriteSWPU API if the IDÅfd PU was rejected during boot due to overlap or out-of-order region.
    ...
    CY_SROM_STATUS_REGULATOR_MODE_MANUAL               = (int32_t)(0xF00000E0ul), // Regulator is configured for ÅgManualÅh mode
    ...
    CY_SROM_STATUS_HASH_FAILED                         = (int32_t)(0xF1000000ul), // Hash on SFLASH trims  failed. The computed  hash is ORÅfd with this status.
