...
def update_compile_message():
    ...
    tree = ET.parse('./iar_8.4/ins.custom_argvars')
    root = tree.getroot()
    ...
    tree.write('./iar_8.4/ins.custom_argvars', encoding='utf-8', xml_declaration=True)

if __name__ == "__main__":
    update_compile_message()
    cmd = "IarBuild.exe ./iar_8.4/ins_m7_1/ins.ewp -build Debug -parallel 4 -varfile ./iar_8.4/ins.custom_argvars"
    os.system(cmd)
